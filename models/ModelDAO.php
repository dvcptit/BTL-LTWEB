...
class ModelClassCredit extends DAO
{
  ...
  public function addObject(object $object): bool
  {
    try {
      ...
      $student_max=$object->getSvMax();
      $teacher_max=$object->getGvMax();
      $tg_max=$object->getTgMax();
      $sql = "INSERT INTO class_credits (class_credit_name, subject_id, group_class, schedule_code,student_max,teacher_max,tutors_max) VALUES (?, ?, ?, ?, ? , ? , ?)";
      $stmt = $this->link->prepare($sql);
      ...
      $stmt->bindParam(5,$student_max,PDO::PARAM_INT);
      $stmt->bindParam(6,$teacher_max,PDO::PARAM_INT);
      $stmt->bindParam(7,$tg_max,PDO::PARAM_INT);
