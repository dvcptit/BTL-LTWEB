    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-10 justify-content-center">
                ...
                <?php echo '<div><a class=" btn-get-started" href="http://localhost:8888/BT3-WEB/admin/addregister" title="Sửa Thông Tin" data-toggle="tooltip" >  Thêm đăng ký </a> </div>'; ?>
                <table class="table table-hover table-bordered table-responsive animate__animated animate__fadeInUp">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="text-center align-middle"
                                style="width: 4%;background-color: #9400D3; color:#fff">Họ tên</th>
                            <th class="text-center align-middle"
                                style="width: 4%;background-color: #9400D3; color:#fff">Môn học</th>
                            <th class="text-center align-middle"
                                style="width: 5%;background-color: #9400D3; color:#fff">Thời gian</th>

                            <th class="text-center align-middle"
                                style="width: 1%;background-color: #9400D3; color:#fff">Nhóm</th>
                            <th class="text-center align-middle"
                                style="width: 4%;background-color: #9400D3; color:#fff">Thao tác</th>
...
<script>
    $(document).ready(function () {
        $("button").click(function (event) {
            ...
            $.ajax({
                url: "http://localhost:8888/BT3-WEB/views/admin/deleteregister.php",
                method: "POST",
