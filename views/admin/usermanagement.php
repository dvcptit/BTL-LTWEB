    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-10 justify-content-center">
                ...
                <?php echo '<div><a class=" btn-get-started" href="http://localhost:8888/BT3-WEB/admin/adduser" title="Sửa Thông Tin" data-toggle="tooltip" >  Thêm người dùng </a> </div>'; ?>
                    ...
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="text-center align-middle"
                                style="width: 5%;background-color: #9400D3; color:#fff">STT</th>
                            <th class="text-center align-middle"
                            ...
                            <th class="text-center align-middle"
                                style="width: 5%;background-color: #9400D3; color:#fff">Vai trò</th>
                            <th class="text-center align-middle"
                                style="width: 5%;background-color: #9400D3; color:#fff">Thao tác</th>
                    ...
                    <tbody>
                        ...
                        foreach ($data as $key => $li) {
                            if (!is_null($li)) {
                                ...
                                echo '<td>';
                                echo '<a class="btn-crud" href="http://localhost:8888/BT3-WEB/admin/usermanagement/' . $li->getUserId() . '" title="Xem Người Dùng" data-toggle="tooltip" ><i class="fa-solid fa-eye"></i></a>';
                                echo '<a class="btn-crud" href="http://localhost:8888/BT3-WEB/admin/updateuser/' . $li->getUserId() . '" title="Sửa Thông Tin" data-toggle="tooltip" > <span><i class="fa-solid fa-pen"></i> </span> </a> ';
...
<script>
    $(document).ready(function () {
        $("button").click(function (event) {
            ...
            $.ajax({
                url: "http://localhost:8888/BT3-WEB/views/admin/deleteuser.php",
                method: "POST",
                data: { userId: userId },
